			...
			<table class="table align-middle gs-0 gy-4">
				...
				<thead>
					<tr class="fw-bold text-muted bg-light">
						<th class="ps-4 min-w-325px rounded-start">Produk</th>
				...
				<tbody>
					<?php
					$data_laptop = select("SELECT laptop.*, 
               ...
               vga_feature.nama_fitur AS vga,
					...
					?>
						<tr>
							<td>
								<div class="d-flex align-items-center">
									<div class="symbol symbol-50px me-5">
										<img src="img/<?= $data['gambar_laptop'] ?>" class="" alt="" />
									</div>
									<div class="d-flex justify-content-start flex-column">
										<a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6"><?= $data['merk_laptop'] ?> - <?= $data['model_laptop'] ?></a>
										<span class="text-muted fw-semibold text-muted d-block fs-7"><?= $data['nama_kategori'] ?></span>
									</div>
								</div>
							</td>
							<td>
							...
							<td>
								<p href="#" class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">Detail Spek </p>
								<span class="text-muted fw-semibold text-muted d-block fs-7">Processor : <?= $data['prosesor'] ?> </span>
								<span class="text-muted fw-semibold text-muted d-block fs-7">Memori : <?= $data['ram'] ?></span>
								<span class="text-muted fw-semibold text-muted d-block fs-7">Storage Capacity : <?= $data['storage'] ?></span>
								<span class="text-muted fw-semibold text-muted d-block fs-7">Graphic Card : <?= $data['vga'] ?></span>
							...
							<td class="text-end">
								...
								<a href="hapus_laptop.php?id=<?= $data['id_laptop'] ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
