	...
	<div class="">
		...
		<div class="modal-content rounded">
			...
			<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
				<!--begin:Form-->
				<form  class="form" action="proses.php?proses=store&jenis=kategori" method="POST" enctype="multipart/form-data">
					<!--begin::Heading-->
					<div class="mb-13 text-center">
						<!--begin::Title-->
						<h1 class="mb-3 mt-5">Tambah Kategori</h1>
						<!--end::Title-->
					...
					<div class="d-flex flex-column mb-8 fv-row">
						...
						<!--end::Label-->
						<input required type="text" class="form-control form-control-solid" placeholder="Masukkan Kategori Laptop" name="kategori_laptop" />
					</div>
					<!--end::Input group-->
