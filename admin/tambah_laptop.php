	...
	<div class="">
		...
		<div class="modal-content rounded">
			...
			<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
				<!--begin:Form-->
				<form  class="form" action="proses.php?proses=store&jenis=laptop" method="POST" enctype="multipart/form-data">
					<!--begin::Heading-->
					<div class="mb-13 text-center">
						<!--begin::Title-->
						<h1 class="mb-3 mt-5">Tambah Laptop</h1>
						<!--end::Title-->
					...
					<div class="d-flex flex-column mb-8 fv-row">
						...
						<!--end::Label-->
						<input required type="text" class="form-control form-control-solid" placeholder="Masukkan Merk Laptop" name="merk_laptop" />
					</div>
					<!--end::Input group-->
					<!--begin::Input group-->
					<div class="row g-9 mb-8">
						...
						<div class="col-md-6 fv-row">
							...
							<!--end::Label-->
							<input required type="text" class="form-control form-control-solid" placeholder="Masukkan Nomor Serial Laptop" name="no_serial" />
						</div>
						<!--end::Input group-->
					</div>
					<!--end::Input group-->
					...
					<div class="row g-9 mb-8">
						...
						<div class="col-md-6 fv-row">
							...
							<!--end::Label-->
							<input required type="text" class="form-control form-control-solid" placeholder="Masukkan Model Laptop" name="model_laptop" />
						</div>
						<!--end::Input group-->
						<!--begin::Input group-->
						<div class="col-md-6 fv-row">
							...
							<!--end::Label-->
							<input required type="text" class="form-control form-control-solid" placeholder="Masukkan Harga Laptop" name="harga_laptop" id="rupiah" />
					...
					<div class="row g-9 mb-8">
						...
						<div class="col-md-6 fv-row">
							...
							<!--end::Label-->
							<input required type="file" class="form-control form-control-solid" name="gambar_laptop" />
