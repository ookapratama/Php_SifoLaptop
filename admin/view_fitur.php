...
<div class="card mb-5 mb-xl-8">
	...
	<div class="card-header border-0 pt-5">
		...
		<div class="card-toolbar">
			<a href="tambah_fitur.php" class="btn btn-sm btn-light-primary" >
			...
			<table class="table align-middle gs-0 gy-4">
				...
				<thead>
					<tr class="fw-bold text-muted bg-light">
						<th class="ps-4 min-w-325px rounded-start">Jenis Fitur</th>
						<th class="ps-4 min-w-325px rounded-start">Nama Fitur</th>
				...
				<tbody>
					<?php
					$jenis_fitur = $_GET['jenis_fitur'];
					if ($jenis_fitur == 'RAM') {
						$jenis_fitur = 'RAM';
					}
					else if ($jenis_fitur == 'Processor') {
						$jenis_fitur = 'Processor';
					}
					else if ($jenis_fitur == 'Storage') {
						$jenis_fitur = 'Storage';
					}
					else if ($jenis_fitur == 'VGA') {
						$jenis_fitur = 'VGA';
					}
					else if ($jenis_fitur == 'Screen') {
						$jenis_fitur = 'Screen';
					}
					
					$data_fitur = select("SELECT * FROM fitur_laptop WHERE jenis_fitur = '$jenis_fitur'");

					while ($data = mysqli_fetch_assoc($data_fitur)) :
					?>
						<tr>
							<td>
								<div class="d-flex align-items-center">
									<div class="d-flex justify-content-start  flex-column">
										<a href="#" class="text-dark fw-bold  text-hover-primary mb-1 fs-6"><?= $data['jenis_fitur'] ?></a>
									</div>
								</div>
							</td>
							<td>
								<div class="d-flex align-items-center">
									<div class="d-flex justify-content-start  flex-column">
										<a href="#" class="text-dark fw-bold  text-hover-primary mb-1 fs-6"><?= $data['nama_fitur'] ?></a>
									</div>
								</div>
							</td>
							...
							<td class="text-end">
								...
								<a href="update_fitur.php?id=<?= $data['id_fitur'] ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
								...
								<a href="hapus_fitur.php?id=<?= $data['id_fitur'] ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
