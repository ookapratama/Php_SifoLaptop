				...
				<form  class="form" action="proses.php?proses=update&jenis=laptop" method="POST" enctype="multipart/form-data">
					...
					<div class="row g-9 mb-8">
						...
						<div class="col-md-6 fv-row">
							...
							<input required type="number" step="0.1" class="form-control form-control-solid" placeholder="Contoh: 1.4" name="berat_laptop" value="<?= $laptop['berat_laptop'] ?>" />
						</div>
						<!--end::Col-->
						<!--begin::Col-->
						<div class="col-md-6 fv-row">
							...
							<input required type="number" class="form-control form-control-solid" placeholder="Contoh: 56" name="baterai_laptop" value="<?= $laptop['baterai_laptop'] ?>" />
						</div>
						<!--end::Col-->
					</div>
					<!--end::Input group-->
					...
					<div class="row g-9 mb-8">
						<div class="col-md-3 fv-row">
							<div class="form-check form-check-custom form-check-solid">
								<input class="form-check-input" type="checkbox" name="is_touchscreen" value="1" id="is_touchscreen" <?= $laptop['is_touchscreen'] == 1 ? 'checked' : '' ?> />
						...
						<div class="col-md-3 fv-row">
							<div class="form-check form-check-custom form-check-solid">
								<input class="form-check-input" type="checkbox" name="is_convertible" value="1" id="is_convertible" <?= $laptop['is_convertible'] == 1 ? 'checked' : '' ?> />
						...
						<div class="col-md-3 fv-row">
							<div class="form-check form-check-custom form-check-solid">
								<input class="form-check-input" type="checkbox" name="has_backlit_kb" value="1" id="has_backlit_kb" <?= $laptop['has_backlit_kb'] == 1 ? 'checked' : '' ?> />
						...
						<div class="col-md-3 fv-row">
							<div class="form-check form-check-custom form-check-solid">
								<input class="form-check-input" type="checkbox" name="has_biometric" value="1" id="has_biometric" <?= $laptop['has_biometric'] == 1 ? 'checked' : '' ?> />
